...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Copy with full path"))
        self.pushButton_3.setText(_translate("MainWindow", "Brows"))
        self.pushButton_4.setText(_translate("MainWindow", "Copy"))
        self.pushButton_5.setText(_translate("MainWindow", "Select"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "copy by file name."))
